...
%Conduct pairwise invasions for phenotypes that vary in m with G_i held
%constatn at 3
...
for a=1:a_num % each phenotype as resident
    parfor b = 1:a_num %each phenotype as invader
        if a == b
        ...
        if exist(['PairwiseInvasion_M_Gis3/outputs_' num2str(pheno_1(1)) '_' num2str(pheno_1(2)) 'by' num2str(pheno_2(1)) '_' num2str(pheno_2(2)) '.mat'], 'file')
            continue
        end
...
function parsave(pheno_1, pheno_2, invasion_prop, total_pop, num_seasons)
    save(['PairwiseInvasion_M_Gis3/outputs_' num2str(pheno_1(1)) '_' num2str(pheno_1(2)) 'by' num2str(pheno_2(1)) '_' num2str(pheno_2(2)) '.mat'], 'pheno_1', 'pheno_2', 'invasion_prop', 'total_pop', 'num_seasons')
end
