% Create Figure 4 of the manuscript showing within season dynamics of
...
for a = 1:2 %cycle through two mixis options
    ...
    title(['m_i= ' num2str(m_i)])
    h = legend({'Resting eggs'; 'Mictic females'; 'Amictic females'; 'Total adults'; 'Mixis threshhold'});
