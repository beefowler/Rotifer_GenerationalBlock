...
%Conduct Pairwise Invasion Experiments for variable G_i phenotypes. 
...
for a=1:a_num %previously stopped at a = 25, b = 355
    parfor b = 1:a_num
        ...
        if exist(['PairwiseInvasion_G/outputs_' num2str(pheno_1(1)) 'T0.2_G' num2str(pheno_1(2)) 'by' num2str(pheno_2(1)) 'T0.2_G' num2str(pheno_2(2)) '.mat'], 'file')
            continue
        end
...
function parsave(pheno_1, pheno_2, invasion_prop, total_pop, num_seasons)
    save(['PairwiseInvasion_G/outputs_' num2str(pheno_1(1)) '_G' num2str(pheno_1(2)) 'by' num2str(pheno_2(1)) '_G' num2str(pheno_2(2)) '.mat'], 'pheno_1', 'pheno_2', 'invasion_prop', 'num_seasons', 'total_pop')
end
